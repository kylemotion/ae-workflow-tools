...
function getComps() {
    ...
    // else if(activeItem && activeItem instanceof CompItem){
    //             compNameArray.push(activeItem)
    // }
...
// var folderPathText = folderPath.replace(/%20/g, " ");
...
saveLocationButton.onClick = function () {
    app.beginUndoGroup("output location");
     var folderPath = getFolderLoc().toString();
     saveLocationChange.text = folderPath.replace(/%20/g, " ");
    app.endUndoGroup()
}
